          ...
          <div className="footer__social">
            ...
            <ul className="footer__social-list">
              <li className="footer__social-list--item">
                <Link href="/">
                  <a className="footer__social-list--link"><FontAwesomeIcon icon={faInstagram} /></a>
                </Link>
              </li>
              <li className="footer__social-list--item">
                <Link href="/">
                  <a className="footer__social-list--link"><FontAwesomeIcon icon={faTwitter} /></a>
                </Link>
              </li>
              <li className="footer__social-list--item">
                <Link href="/">
                  <a className="footer__social-list--link"><FontAwesomeIcon icon={faFacebookF} /></a>
                </Link>
              </li>
              <li className="footer__social-list--item">
                <Link href="/">
                  <a className="footer__social-list--link"><FontAwesomeIcon icon={faYoutube} /></a>
                </Link>
              </li>
            </ul>
          </div>
